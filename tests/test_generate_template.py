...
def test_generate_custom_shipments():
    ...
    informations = {
        ...
        'productor_name': 'productornametest',
        'productor_address': 'productoraddresstest',
        'productor_payment': 'productorpaymenttest',
        'referer_email': 'refereremailtest',
        'referer_name': 'referernametest',
